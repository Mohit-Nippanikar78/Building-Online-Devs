...
const FooterAnchor = () => {
    return (
        <div className="lg:mx-32 bg-white text-black flex items-center">
            <div className="grid grid-cols-1 w-full  lg:grid-cols-2 place-items-center lg:px-12 py-20 bg-cover" style={{ backgroundImage: "url('/images/productCatalogue/anchor.png')" }}>
                ...
                <div className={`text-sm w-80 lg:w-auto m-auto ${window.innerWidth < 1024 && "mt-4"} `}>
...
const AnchorButton = () => {
    ...
    >
        ...
        <div className={`overflow-visible z-10 absolute top-0 left-0  h-full transition-all duration-700 ${btnHover
            ? "w-full bg-neutral-800  px-4 py-2 rounded-md"
            : " px-4 py-2 rounded-md w-1/2 border-neutral-800 border-2 border-r-0"}`}
        ></div>
    </div>)
}
