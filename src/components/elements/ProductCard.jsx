...
const ProductCard = ({ course, type }) => {
    ...
    return (
        <div className={`snap-center flex  flex-col text-center items-center  rounded-md bg-white ${type !== "productCatalogue" ? "bg-opacity-70 mx-4 min-w-[240px]" : "w-64"}`} style={{ boxShadow: "rgba(14, 30, 37, 0.12) 0px 2px 4px 0px, rgba(14, 30, 37, 0.32) 0px 2px 16px 0px" }}>
            ...
            <div className="text-base py-4 text-left px-4">
                ...
                <div className="flex justify-between ">
                    ...
                    <button className="rounded-md border-[#3c3c3c] px-4 py-2 border-2 border-solid">
