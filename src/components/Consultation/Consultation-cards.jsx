...
const ConsultationCards = () => {
    return (
        <div className="flex flex-col md:w-full w-auto md:flex-row lg:max-h-[320px] lg:my-32  justify-evenly items-scretch  h-full ">
            <img
                src="/images/consultation/sm-card.png"
                className="lg:hidden"
                alt=""
            />
            <img
                src="/images/consultation/lg-card.png"
            ...
            >
                <div className="text-2xl font-bold capitalize ">
                    we are made up of
                    <span className="text-lime"> Expert developers </span>
                    with
                    <span className="text-lime"> Real experience </span>
                </div>
